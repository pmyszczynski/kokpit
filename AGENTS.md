...
- **Widget UI library work:** read [`docs/widget-consistency-plan.md`](docs/widget-consistency-plan.md) and the [component/widget tracker](docs/widget-ui-library.md). Work only on the owner-selected step and keep both tables current.
